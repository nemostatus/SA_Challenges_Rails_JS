class Attempt {
  ...
  renderAttempts() {
    ...
    attemptsDiv.innerHTML += `
            ...
            <button class="cheer" data-id = ${this.id} data-cheer = ${this.cheer} onClick="updateAttempt()">  <i class='fas fa-star' style='font-size:24px;color: gold'></i> Cheer on attempt! </button>
            </ul>
